...
<div class="modal fade" id="ModalCustomAlertReload" tabindex="-1" aria-labelledby="Alert" aria-hidden="true" >
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <span id="ModalCustomTextAlert"> Unable to connect to the rcms system. </span>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
      </div>
...
<!--             <li class="nav-item">
          ...
          <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" href="system.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">   
          <button id="buttonChangeID" type="button" class="btn btn-sm btn-outline-secondary   align-items-center gap-1 m-1 d-flex"  data-bs-toggle="modal" data-bs-target="#confirmToRebootSystem">
          <svg class="bi"><use xlink:href="fontawesome-free-5.15.4-web/sprites/solid.svg#redo-alt"/></svg>
          REBOOT
          </button> 
        </div>
      </div>
    ...
    <?php
      ...
      echo '<div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-4 row-cols-xl-6">';
        ...
        echo '  <div class="card m-1 p-1" style="min-width: 368px;">';
        echo '    <div class="container m-0 p-2" style="width: 100%;height: 100%;">';
        echo '      <div class="row align-items-center" >';
        ...
        // if ($total >= 3)
        // {
        //   echo('<span>Found backup file '.$files[2].', Pls download file.</span>');
        //   echo '<form action="database/'.$files[2].'">';    
        //   echo('<button style="width: 100%;" class="btn btn-primary" type="submit" value="Go to download">DOWNLOAD</button>');
        //   echo '</form>';
        // }     
        echo '</div>';
        ...
        echo '              <span style="display: flex; justify-content: center; width:100%">UPLOAD</span>';
        echo '           </button>';
        // echo '        <button style="width: 100%;" class="btn btn-primary"  type="submit" value="restorefile">UPLOAD</button>';
        echo '        </div>';
        echo '        </form>';
...
echo '  <div class="card m-1 p-1" style="min-width: 367px;">';
        ...
        {
          echo '  <div id="divEth'.$ethIndex.'" class="card m-1 p-1" style="min-width: 367px; display:none;">';
          echo '    <div class="container m-0 p-2" style="width: 100%;height: 100%;">';
          echo '      <div class="row align-items-center" >';
          echo '    <div class="row m-0">';
 ...
 <?php
  if(isset($_FILES['fileToUpload'])){
    ...
    // if everything is ok, try to upload file
      ...
      {
        echo '<script language="javascript">';
        echo "ModalCustomAlert('Sorry, there was an error uploading your file.')";        
        echo '</script>';
      }
    }
  }
