...
// DFlog Viewer (CSV Logs) — list/view/download
// ✅ DELETE via WebSocket -> C++/Qt ONLY (NO PHP DELETE)
...
// =========================================================
// DOWNLOAD (single csv) — allowed via PHP
// =========================================================
      ...
      <?php else: ?>
        ...
        <?php if ($isViewerMode && $viewer): ?>
          <!-- =======================
               SINGLE LOG VIEW
               ======================= -->
          <div class="card log-card shadow-sm" data-rel="<?php echo h($viewer['rel']); ?>">
            <div class="card-body">
              ...
              <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  ...
                  <!-- ✅ DELETE via WS -->
                  <button type="button"
                          class="btn btn-danger df-del-one"
        ...
        <?php else: ?>
          <!-- =======================
               LOG LIST + FILTERS + BULK DELETE (WS)
               ======================= -->
          ...
          <?php else: ?>
            ...
            <div class="sticky-actions border-bottom mb-3">
              <div class="d-flex flex-wrap gap-2 align-items-center">
                ...
                <!-- ✅ BULK DELETE via WS -->
                <button type="button" class="btn btn-danger btn-sm" onclick="return DFLOG_sendDeleteSelectedWS();">
                  <svg class="bi"><use xlink:href="dashboard.svg#trash"/></svg>
                  Delete Selected
                </button>
            ...
            <div class="row g-3">
              <?php foreach ($logs as $it): ?>
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="card log-card h-100 shadow-sm" data-rel="<?php echo h($it['rel']); ?>">
                    <div class="card-body">
                      ...
                      <div class="mt-3 d-flex gap-2 flex-wrap">
                        ...
                        <!-- ✅ DELETE via WS -->
                        <button type="button"
                                class="btn btn-sm btn-danger df-del-one"
